# Pokedle - Cursor Rules

## Project Overview
Pokedle es una aplicación web tipo Wordle adaptada a la franquicia Pokémon, desarrollada con Next.js 15+ y TypeScript. Los usuarios deben adivinar un Pokémon diario en intentos limitados; el sistema proporciona pistas comparando atributos como Generación (mayor/menor/igual), Tipo(s) y Hábitat/Color/Evolución. Se integra con PokeAPI para obtener datos de los Pokémon en tiempo real.

Los usuarios no registrados pueden jugar la partida diaria sin persistencia permanente. Los usuarios registrados disponen de perfil, estadísticas históricas (victorias y rachas), acceso a un ranking global basado en tiempo e intentos, historial de desafíos de los últimos 5 días y una sección de blog/foro para comentar estrategias y compartir resultados.
